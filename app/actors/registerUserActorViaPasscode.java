 ...
 */
public class registerUserActorViaPasscode extends UntypedActor {

    public String insertQueryRegisterBuilder(RegisteredUser reguser){
        return "UPDATE user_profiles SET password_string = SHA2("+reguser.password+",512) where email = " + reguser.email;
    }
